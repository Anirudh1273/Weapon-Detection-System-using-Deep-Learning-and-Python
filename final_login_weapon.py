...
s.starttls()
s.login("anirudhgrandhi12@gmail.com", "cpjdlfuhuqlkajwz")
...
set_background_image('weapon1.jpg')
            ...
            for box in boxes:
                ...
                if confidence > 50:
                    ...
                    if classnames[Class] == "weapon":
                        ...
                        s.sendmail("anirudhgrandhi12@gmail.com", "anirudh120703@gmail.com", message)
                        playsound('3.wav')
